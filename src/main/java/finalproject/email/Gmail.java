...
@Service
public class Gmail {
    private static final String TEST_EMAIL = "zappulla850@gmail.com";
    ...
    public String buildConfirmationPage(String link) {
